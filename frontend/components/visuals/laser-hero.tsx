        ...
        <div className="relative xl:max-w-7xl max-w-6xl mx-auto py-4 lg:px-0 px-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <span className="text-2xl font-bold text-white">Mysh Devs :]</span>
            </div>
            ...
            <button className="bg-white text-black hover:bg-gray-100 px-6 py-2 rounded-full font-medium transition-colors duration-200 flex items-center gap-2">
              Start Now
